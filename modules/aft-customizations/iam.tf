...
resource "aws_iam_role_policy" "aft_codepipeline_customizations_policy" {
  ...
  policy = templatefile("${path.module}/iam/role-policies/aft_codepipeline_customizations_policy.tpl", {
    ...
    aws_s3_bucket_aft_account_customizations_bucket_arn      = data.aws_s3_bucket.s3_account_customizations_bucket.arn
    aws_s3_bucket_aft_global_customizations_bucket_arn       = data.aws_s3_bucket.s3_global_customizations_bucket.arn
